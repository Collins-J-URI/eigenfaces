...
ImageLaplacian_Gaussian_F::ImageLaplacian_Gaussian_F(int theWidth)
	:	ImageLaplacian( )
{
    FAIL_CONDITION( theWidth < 5,
                    kFilterAllocationError,
                    "The smallest width admissible for a Laplacian filter is 5");
...
ImageLaplacian_Gaussian_F::ImageLaplacian_Gaussian_F(const ImageLaplacian_Gaussian_F& obj)
		:	GraphicComponent3D(),
			//
			vertex_(NULL),
			normal_(NULL),
...
const ImageLaplacian_Gaussian_F& ImageLaplacian_Gaussian_F::operator = (const ImageLaplacian_Gaussian_F& obj)
{
    FAIL_CONDITION( true,
                    kFunctionNotImplemented,
...
RasterImage* ImageLaplacian_Gaussian_F::applyTo(RasterImage* imgIn)
{
...
RasterImage* ImageLaplacian_Gaussian_F::applyTo(RasterImage* imgIn, ImageRect* theRect)
{
    FAIL_CONDITION(	imgIn == NULL,
    				kNullRasterImageError,
    				"NULL input raster image passed as parameter");
...
void ImageLaplacian_Gaussian_F::applyInto(RasterImage* imgIn, RasterImage* imgOut)
{
    FAIL_CONDITION(	imgIn == NULL,
    				kNullRasterImageError,
    				"NULL input raster image passed as parameter");
...
void ImageLaplacian_Gaussian_F::applyInto(RasterImage* imgIn, ImageRect* theRect, RasterImage* imgOut)
{
	//----------------------------------------------------------------
...
void ImageLaplacian_Gaussian_F::applyInto_5x5_(RasterImage* imgIn, ImageRect* theRect,
                                                RasterImage* imgOut)
{
    ...
    int	i, im1, im2,
    		ip1, ip2;
    float   **fOut = ((RasterImage_gray_F *) imgOut)->getShiftedGrayF2D();
    ...
    if (imgIn->getBaseRasterType() == kGrayRaster)
    {
        ...
        {
            unsigned char   **iGray = imgIn->getShiftedRaster2D();
        ...
        {
            float   **fGray = ((RasterImage_gray_F *) imgIn)->getShiftedGrayF2D();
...
void ImageLaplacian_Gaussian_F::applyInto_7x7_(RasterImage* imgIn, ImageRect* theRect,
                                                RasterImage* imgOut)
{
    //  This private function is called after all data validity tests have been performed
    //  We know that the images are valid and that the rectangle fits both the input and
...
void ImageLaplacian_Gaussian_F::applyInto_9x9_(RasterImage* imgIn, ImageRect* theRect,
                                                RasterImage* imgOut)
{
    //  This private function is called after all data validity tests have been performed
    //  We know that the images are valid and that the rectangle fits both the input and
    ...
    int   iLow = theRect->getTop(),
            ...
            jLow = theRect->getLeft(),
            jHigh = theRect->getRight();
    int	j, jm1, jm2, jm3, jm4,
    		jp1, jp2, jp3, jp4;
    int	i, im1, im2, im3, im4,
    		ip1, ip2, ip3, ip4;
    float   **fOut = ((RasterImage_gray_F *) imgOut)->getShiftedGrayF2D();
...
void ImageLaplacian_Gaussian_F::applyInto_11x11_(RasterImage* imgIn, ImageRect* theRect,
                                                RasterImage* imgOut)
{
    //  This private function is called after all data validity tests have been performed
    //  We know that the images are valid and that the rectangle fits both the input and
    ...
    int   iLow = theRect->getTop(),
            ...
            jLow = theRect->getLeft(),
            jHigh = theRect->getRight();
    int	j, jm1, jm2, jm3, jm4, jm5,
    		jp1, jp2, jp3, jp4, jp5;
    int	i, im1, im2, im3, im4, im5,
    		ip1, ip2, ip3, ip4, ip5;
    float   **fOut = ((RasterImage_gray_F *) imgOut)->getShiftedGrayF2D();
...
void ImageLaplacian_Gaussian_F::applyInto_13x13_(RasterImage* imgIn, ImageRect* theRect,
                                                RasterImage* imgOut)
{
    //  This private function is called after all data validity tests have been performed
    //  We know that the images are valid and that the rectangle fits both the input and
    ...
    int   iLow = theRect->getTop(),
            ...
            jLow = theRect->getLeft(),
            jHigh = theRect->getRight();
    int	j, jm1, jm2, jm3, jm4, jm5, jm6,
    		jp1, jp2, jp3, jp4, jp5, jp6;
    int	i, im1, im2, im3, im4, im5, im6,
...
void ImageLaplacian_Gaussian_F::applyInto_(RasterImage* imgIn, ImageRect* theRect,
                                                RasterImage* imgOut)
{
    //  This private function is called after all data validity tests have been performed
    //  We know that the images are valid and that the rectangle fits both the input and
...
{
    int   m = width_/2;
    double  sigma2 = scale_ * scale_,
    		twoSigma2 = 2.L * sigma2,
