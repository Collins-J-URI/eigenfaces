/*  NAME:
        PatternMatcher2D_corr.cpp
 
    DESCRIPTION:
        implementation of the uriVisionLib PatternMatcher2D_corr class
...
PatternMatcher2D_corr::PatternMatcher2D_corr(void)
    :   PatternMatcher2D( )
{
...
void PatternMatcher2D_corr::setPattern(const Pattern2D* pat)
{
...
void PatternMatcher2D_corr::setPattern(const RasterImage* patImg, const Blob* patBlob)
{
...
void PatternMatcher2D_corr::match_(const RasterImage_RGBa* patImg, 
...
void PatternMatcher2D_corr::match_(const RasterImage_gray* patImg, 
                                   const ImageRect* searchRect, 
...
void PatternMatcher2D_corr::covariance(const RasterImage_RGBa* img, int x, int y, float* cov, 
                                       float* corrScale)
{
...
void PatternMatcher2D_corr::covariance(const RasterImage_gray* img, int x, int y, float* cov, 
                                       float* corrScale)
{
    FAIL_CONDITION(	cov == NULL,
                    kNullParameterError,
...
void PatternMatcher2D_corr::covarianceRGBa_(const unsigned char* const* rgbaImg, int x, int y, 
...
void PatternMatcher2D_corr::covarianceGray_(const unsigned char* const* grayImg, int x, int y, 
                                            float* cov, float* corrScale)
{
...
void PatternMatcher2D_corr::covarianceRGBaBlob_(const unsigned char* const* rgbaImg, int x, int y, 
                                                float* cov, float* corrScale)
{
...
void PatternMatcher2D_corr::covarianceGrayBlob_(const unsigned char* const* grayImg, int x, int y, 
                                                float* cov, float* corrScale)
{
    const   float   nbPixelsScale = 1.f / patBlob_->getNbPixels();
...
void PatternMatcher2D_corr::patternCorrScale(const RasterImage_RGBa* patImg, float* patCorrScale)
{
    FAIL_CONDITION(	patImg == NULL,
                    kNullRasterImageError,
...
void PatternMatcher2D_corr::patternCorrScale(const RasterImage_gray* patImg, float* patCorrScale)
{
    FAIL_CONDITION(	patImg == NULL,
                    kNullRasterImageError,
                    "NULL pattern passed as parameter to PatternMatcher2D_corr::patternCorrScale");
...
void PatternMatcher2D_corr::patternCorrScale(const RasterImage_RGBa* patImg, const Blob* patBlob, 
                                             float* patCorrScale)
{
    FAIL_CONDITION(	patImg == NULL,
                    kNullRasterImageError,
...
void PatternMatcher2D_corr::patternCorrScale(const RasterImage_gray* patImg, const Blob* patBlob,
                                             float* patCorrScale)
{
    FAIL_CONDITION(	patImg == NULL,
                    kNullRasterImageError,
...
void PatternMatcher2D_corr::patternCorrScale_(const RasterImage_RGBa* patImg, 
                                              float* patCorrScale)
{
    setPattern(patImg);
...
void PatternMatcher2D_corr::patternCorrScale_(const RasterImage_gray* patImg, 
                                              float* patCorrScale)
{
    setPattern(patImg);
...
void PatternMatcher2D_corr::patternCorrScale_(const RasterImage_RGBa* patImg, const Blob* patBlob, 
                                              float* patCorrScale)
{
...
void PatternMatcher2D_corr::patternCorrScale_(const RasterImage_gray* patImg, const Blob* patBlob,
                                              float* patCorrScale)
{
    setPattern(patImg, patBlob);
...
bool PatternMatcher2D_corr::isProperMatchRecordType_(const Pattern2DMatchRecord* matchRecord) const
{
    //  the correlation matcher only requires a generic match record
    return true;
}

Pattern2DMatchRecord* PatternMatcher2D_corr::newPattern2DMatchRecord_(void)
{
...
void PatternMatcher2D_corr::deleteRasters_(void)
{
...
void PatternMatcher2D_corr::allocateRasters_(const RasterImage* patImg, const Blob* patBlob)
{
