/*  NAME:
    ...
    DESCRIPTION:
        _ImageWriter_hack public header.
...
*/
#ifndef URIVL_IMAGE_WRITER_GEN_H
#define URIVL_IMAGE_WRITER_GEN_H
...
namespace uriVL
{
     ...
     *  This one implements the reader using only "generic" C++ code (so far).
     ...
     */
    class URIVL_EXPORT _ImageWriter_hack
    {
        ...
        private:
            ...
            bool    dataRefDefined_;
 			...
 			/**	Default constructor
			 */
            _ImageWriter_hack(void);

			/**	Copy constructor
			 *	@param	obj		the object to copy
			 */
            _ImageWriter_hack(const _ImageWriter_hack& obj);
			 ...
			 *	@param	obj		the object to copy
			 */
            const _ImageWriter_hack& operator =(const _ImageWriter_hack& obj);
			 ...
			 *									(temp. setting for some tga files)
			 */
            static void writePPM_(const RasterImage* theImage, const char* filePath, bool upsideDown);
			 ...
			 *									(temp. setting for some tga files)
			 */
            static void writePGM_(const RasterImage* theImage, const char* filePath, bool upsideDown);
			 ...
			 *									(temp. setting for some tga files)
			 */
			static void writeTGA_(const RasterImage* theImage, const char* filePath, bool upsideDown);
