/*  NAME:
    LinearSolver_Jacobi.h
 
  DESCRIPTION:
    LinearSolver_Jacobi public header.
...
*/
#ifndef URIVL_LINEAR_SOLVER_JACOBI_H
#define URIVL_LINEAR_SOLVER_JACOBI_H
...
namespace uriVL
{
    /** Class that implement the Jacobi iterative algorithm for solving SLEs.
	 *
     ...
     *                      University of Rhode Island
     */
    class URIVL_EXPORT LinearSolver_Jacobi : public LinearSolver
    {
        public:

            /** Space is allocated for a new LinearSolver_Jacobi object. That matrix must have
             ...
             */
            LinearSolver_Jacobi(int nbRows, int nbCols);


            /** Constructor.  A LinearSolver_Jacobi is created for a specific matrix.
             ...
             */
            LinearSolver_Jacobi(Matrix* A, bool preserveMatrix=false);
...
//             *                          advance.
//             */
//            LinearSolver_Jacobi(int n, int nbRighSideCols=1);
            
            
            /** Destructor
             */
            ~LinearSolver_Jacobi(void);
        ...
        private:
             ...
             */
            LinearSolver_Jacobi(const LinearSolver_Jacobi& obj);

            /** Copy operator: disabled.
			 *	@param	obj		reference to the object to copy
             */
            const LinearSolver_Jacobi& operator = (const LinearSolver_Jacobi& obj);
