...
namespace uriVL
{
    ...
    class URIVL_EXPORT ImageLaplacian_Gaussian_I : public ImageLaplacian
    {
        public:
             ...
             *  Destructor
             */          
            virtual ~ImageLaplacian_Gaussian_I(void);
        ...
        protected:
             ...
             */
            ImageLaplacian_Gaussian_I(const ImageLaplacian_Gaussian_I& obj);
             ...
             *  @param  obj   reference of the object to copy
             */
            const ImageLaplacian_Gaussian_I& operator =(const ImageLaplacian_Gaussian_I& obj);
