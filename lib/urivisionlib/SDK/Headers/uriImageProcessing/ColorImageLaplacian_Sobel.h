...
namespace uriVL
{
    ...
    class URIVL_EXPORT ImageLaplacian_Sobel : public ImageLaplacian
    {
        ...
        private:
             ...
             *  @param  imgOut      the RasterImage into which the output is written
             */ 
            void applyInto_form1_(RasterImage* imgIn, const ImageRect* theRect, RasterImage* imgOut);
             ...
             *  @param  imgOut      the RasterImage into which the output is written
             */ 
            void applyInto_form2_(RasterImage* imgIn, const ImageRect* theRect, RasterImage* imgOut);
             ...
             *  @param  imgOut      the RasterImage into which the output is written
             */ 
            void applyInto_form3_(RasterImage* imgIn, const ImageRect* theRect, RasterImage* imgOut);
