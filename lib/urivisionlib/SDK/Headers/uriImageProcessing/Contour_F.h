...
*/
#ifndef URIVL_CONTOUR_F_H
#define URIVL_CONTOUR_F_H
...
namespace uriVL
{
    ...
    /** Set of float ImagePoint objects which compose a closed curve
     *
     *  @author Clifford Manzanillo, jyh	Department of Computer Science and Statistics,
     *										University of Rhode Island
     */
    class URIVL_EXPORT Contour_F : public Contour
    {
        public:
             ...
             *  @param  pts array of points to initialize thed contour with
             */
            Contour_F(int n, const ImagePoint_F*const* pts);

            /** Creates a contour and initializes it with the points recived as parameters
             *  @param  ptsList ImagePointList
             */
            Contour_F(const ImagePointList* ptsList);
             ...
             *  @see    edgeList_
             */
            const std::list <ImagePoint_F*> *getEdgeList(void);
        ...
        private:
             ...
             */
            std::list<ImagePoint_F*> contourList_;

            /** List of edges of the contour
             */
            mutable std::list <ImagePoint_F *>  edgeList_;
             ...
             */
            const Contour_F& operator = (const Contour_F& theObj);
