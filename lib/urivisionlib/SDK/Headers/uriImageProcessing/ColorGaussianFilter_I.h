/*  NAME:
        ColorGaussianFilter_I.h
 
    DESCRIPTION:
        ColorGaussianFilter_I public header.
...
*/
#ifndef URIVL_COLOR_GAUSSIAN_FILTER_I_H
#define URIVL_COLOR_GAUSSIAN_FILTER_I_H
...
namespace uriVL
{
    ...
    /** ColorGaussianFilter_I class.  Implements the application of a Gaussian filter
     ...
     */
    class URIVL_EXPORT ColorGaussianFilter_I : public ColorGaussianFilter
    {
        public:
             ...
             */
            ColorGaussianFilter_I(double theScale);
             ...
             */
            ColorGaussianFilter_I(int theWidth);
             ...
             */
            ColorGaussianFilter_I(double theScale, const ImageRect* theRect);
             ...
             *  @param theRect  bounding rectangle for the temporary raster
             */
            ColorGaussianFilter_I(int theWidth, const ImageRect* theRect);

            /** Destructor
             */
            ~ColorGaussianFilter_I(void);
        ...
        private:
             ...
             */
            ColorGaussianFilter_I(const ColorGaussianFilter_I& obj);
             ...
             *  @param  obj   reference of the object to copy
             */
            const ColorGaussianFilter_I& operator =(const ColorGaussianFilter_I& obj);
...
#endif  //  COLOR_GAUSSIAN_FILTER_I_H
