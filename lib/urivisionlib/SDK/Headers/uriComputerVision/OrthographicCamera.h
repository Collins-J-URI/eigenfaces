/*  NAME:
    ...
    DESCRIPTION:
        OrthographicCamera public header.
...
*/
#ifndef URIVL_ORTHOGRAPHIC_CAMERA_H
#define URIVL_ORTHOGRAPHIC_CAMERA_H
...
namespace uriVL
{
	/** Implements the OrthographicCamera class.
	 * 
     *  @author jean-yves herve', 3D Group, 
     *                              Department of Computer Science and Statistics,
     *                              University of Rhode Island
	 *
	 *	@see		IntrinsicParameters_CCD
	 */
	class URIVL_EXPORT OrthographicCamera : public Camera
	{
		...
		public:
              ...
              */
			OrthographicCamera(IntrinsicParameters *params, RigidTransformation3D *transf=NULL);
