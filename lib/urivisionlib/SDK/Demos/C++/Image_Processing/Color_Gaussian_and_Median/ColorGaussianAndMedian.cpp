...
void loadImage(void)
{
    ...
    gMyImage[UPPER_RIGHT] = new RasterImage_RGBa(gMyImage[UPPER_LEFT]);
    gMyImage[UPPER_RIGHT]->setDrawValidDataFrame(true);
    gMyImage[UPPER_RIGHT]->setFrameColor(0.f, 1.f, 1.f);

    //	Images 2 and 3 are created with as RGBa_F images with the same bounding rectangle
    //  as image 0.  Initialized with the same values as Image 1
    gMyImage[LOWER_LEFT] = new RasterImage_RGBa_F(gMyImage[UPPER_RIGHT]);
    gMyImage[LOWER_LEFT]->setDrawValidDataFrame(true);
    gMyImage[LOWER_LEFT]->setFrameColor(0.f, 1.f, 1.f);
    gMyImage[LOWER_RIGHT] = new RasterImage_RGBa_F(gMyImage[UPPER_RIGHT]);
...
void myMenu2(int value)
{
    switch (value)
    {
        ...
        case 13:
        case 21:
            ColorGaussianFilter_F    *gauss;
            gauss = new ColorGaussianFilter_F((int) value);
            gauss->applyInto(gMyImage[1], gMyImage[2]);
            delete gauss;
            glutSetWindow(gMainWindow);
            glutPostRedisplay();
            break;
...
void myMenu3(int value)
{
    switch (value)
    {
        ...
        case 11:
        case 13:
            ColorMedianFilter_I    *median;
            median = new ColorMedianFilter_I((int) value);
            median->applyInto(gMyImage[1], gMyImage[3]);
            delete median;
            glutSetWindow(gMainWindow);
            glutPostRedisplay();
            break;
...
void myInit(void)
{
    ...
    glutAddMenuEntry("3x3 color Gaussian", 3);
    glutAddMenuEntry("5x5 color Gaussian", 5);
    glutAddMenuEntry("7x7 color Gaussian", 7);
    glutAddMenuEntry("9x9 color Gaussian", 9);
    glutAddMenuEntry("11x11 color Gaussian", 11);
    glutAddMenuEntry("13x13 color Gaussian", 13);
    glutAddMenuEntry("21x21 color Gaussian", 21);
    //
    ...
    glutAddMenuEntry("3x3 color median", 3);
    glutAddMenuEntry("5x5 color median", 5);
    glutAddMenuEntry("7x7 color median", 7);
    glutAddMenuEntry("9x9 color median", 9);
    glutAddMenuEntry("11x11 color median", 11);
    glutAddMenuEntry("13x13 color median", 13);
    //
...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        gMainWindow = glutCreateWindow("Color Gaussian and Median Demo");
