...
RasterImage* ImageLaplacian_Sobel::applyTo(RasterImage* imgIn)
{
...
RasterImage* ImageLaplacian_Sobel::applyTo(RasterImage* imgIn, ImageRect* theRect)
{
    FAIL_CONDITION(	imgIn == NULL,
                    kNullRasterImageError,
                    "NULL input raster image passed as parameter");
...
void ImageLaplacian_Sobel::applyInto(RasterImage* imgIn, RasterImage* imgOut)
{
    FAIL_CONDITION(	imgIn == NULL,
                    kNullRasterImageError,
                    "NULL input raster image passed as parameter");
...
void ImageLaplacian_Sobel::applyInto(RasterImage* imgIn, ImageRect* theRect, RasterImage* imgOut)
{
    //----------------------------------------------------------------
...
void ImageLaplacian_Sobel::applyInto_form1_(RasterImage* imgIn, ImageRect* theRect,
        RasterImage* imgOut)
{
    ...
    {
        float   **inGray = ((RasterImage_gray_F *) imgIn)->getShiftedGrayF2D();
        float   **outGray = ((RasterImage_gray_F *) imgOut)->getShiftedGrayF2D();
    ...
    {
        unsigned char   **inGray = imgIn->getShiftedRaster2D();
        float   		**outGray = ((RasterImage_gray_F *) imgOut)->getShiftedGrayF2D();
...
void ImageLaplacian_Sobel::applyInto_form2_(RasterImage* imgIn, ImageRect* theRect,
        RasterImage* imgOut)
{
    int   iLow  = theRect->getTop(),
                    iHigh = theRect->getBottom(),
...
void ImageLaplacian_Sobel::applyInto_form3_(RasterImage* imgIn, ImageRect* theRect,
        RasterImage* imgOut)
{
    int   iLow  = theRect->getTop(),
                    iHigh = theRect->getBottom(),
