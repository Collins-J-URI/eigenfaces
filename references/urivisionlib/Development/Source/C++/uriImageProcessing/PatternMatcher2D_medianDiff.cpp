/*  NAME:
        PatternMatcher2D_medianDiff.cpp
 
    DESCRIPTION:
        implementation of the uriVisionLib PatternMatcher2D_medianDiff class
...
PatternMatcher2D_medianDiff::PatternMatcher2D_medianDiff(void)
    :   PatternMatcher2D( )
{
...
void PatternMatcher2D_medianDiff::setPattern(const Pattern2D* pat)
{
    FAIL_CONDITION(	pat == NULL,
                    kNullParameterError,
                    "NULL pattern sent as parameter to PatternMatcher2D_medianDiff::setPattern");
    setPattern(pat->getPattern(), pat->getBlob());
}

void PatternMatcher2D_medianDiff::setPattern(const RasterImage* patImg, const Blob* patBlob)
{
    FAIL_CONDITION(	patImg == NULL,
                    kNullRasterImageError,
                    "NULL image sent as parameter to PatternMatcher2D_medianDiff::setPattern");
    ...
    FAIL_CONDITION(	(patRasterType != kGrayRaster) && (patRasterType != kRGBa32Raster),
                    ...
                    "PatternMatcher2D_medianDiff::setPattern only takes gray and RGBa images");
...
void PatternMatcher2D_medianDiff::match_(const RasterImage_RGBa* patImg, 
...
void PatternMatcher2D_medianDiff::match_(const RasterImage_gray* patImg, 
										const ImageRect* searchRect, 
...
void PatternMatcher2D_medianDiff::match_(const RasterImage_RGBa* patImg, const Blob* patBlob, 
										const ImageRect* searchRect, 
										const RasterImage_RGBa* img, 
										Pattern2DMatchRecord* matchRecord)
{
...
void PatternMatcher2D_medianDiff::match_(const RasterImage_gray* patImg, const Blob* patBlob, 
									   const ImageRect* searchRect, 
									   const RasterImage_gray* img, 
									   Pattern2DMatchRecord* matchRecord)
{
...
void PatternMatcher2D_medianDiff::covariance(const RasterImage_RGBa* img, int x, int y, float* cov, 
											float* corrScale)
{
    FAIL_CONDITION(	cov == NULL,
                    kNullParameterError,
                    "NULL covariance array sent to PatternMatcher2D_medianDiff::covariance");
    FAIL_CONDITION(	corrScale == NULL,
                    kNullParameterError,
                    "NULL correlation scale array sent to PatternMatcher2D_medianDiff::covariance");
    FAIL_CONDITION(	img == NULL,
                    kNullRasterImageError,
                    "NULL raster image sent to PatternMatcher2D_medianDiff::covariance");
...
void PatternMatcher2D_medianDiff::covariance(const RasterImage_gray* img, int x, int y, float* cov, 
											float* corrScale)
{
    FAIL_CONDITION(	cov == NULL,
                    kNullParameterError,
...
void PatternMatcher2D_medianDiff::covarianceRGBa_(const unsigned char* const* rgbaImg, int x, int y, 
...
void PatternMatcher2D_medianDiff::covarianceGray_(const unsigned char* const* grayImg, int x, int y, 
												float* cov, float* corrScale)
{
...
void PatternMatcher2D_medianDiff::covarianceRGBaBlob_(const unsigned char* const* rgbaImg, int x, int y, 
													float* cov, float* corrScale)
{
...
void PatternMatcher2D_medianDiff::covarianceGrayBlob_(const unsigned char* const* grayImg, int x, int y, 
                                                float* cov, float* corrScale)
{
    const   float   nbPixelsScale = 1.f / patBlob_->getNbPixels();
...
void PatternMatcher2D_medianDiff::patternCorrScale(const RasterImage_RGBa* patImg, float* patCorrScale)
{
    FAIL_CONDITION(	patImg == NULL,
                    kNullRasterImageError,
                    "NULL pattern passed as parameter to PatternMatcher2D_medianDiff::patternCorrScale");
    FAIL_CONDITION(	patCorrScale == NULL,
                    kNullParameterError,
                    "NULL correlation scale array sent to PatternMatcher2D_medianDiff::patternCorrScale");
    
    patternCorrScale_(patImg, patCorrScale);
}

void PatternMatcher2D_medianDiff::patternCorrScale(const RasterImage_gray* patImg, float* patCorrScale)
{
    FAIL_CONDITION(	patImg == NULL,
                    kNullRasterImageError,
                    "NULL pattern passed as parameter to PatternMatcher2D_medianDiff::patternCorrScale");
...
void PatternMatcher2D_medianDiff::patternCorrScale(const RasterImage_RGBa* patImg, const Blob* patBlob, 
                                             float* patCorrScale)
{
    FAIL_CONDITION(	patImg == NULL,
                    kNullRasterImageError,
...
void PatternMatcher2D_medianDiff::patternCorrScale(const RasterImage_gray* patImg, const Blob* patBlob,
                                             float* patCorrScale)
{
    FAIL_CONDITION(	patImg == NULL,
                    kNullRasterImageError,
...
void PatternMatcher2D_medianDiff::patternCorrScale_(const RasterImage_RGBa* patImg, 
													float* patCorrScale)
{
    setPattern(patImg);
...
void PatternMatcher2D_medianDiff::patternCorrScale_(const RasterImage_gray* patImg, 
													float* patCorrScale)
{
    setPattern(patImg);
...
void PatternMatcher2D_medianDiff::patternCorrScale_(const RasterImage_RGBa* patImg, const Blob* patBlob, 
                                              float* patCorrScale)
{
...
void PatternMatcher2D_medianDiff::patternCorrScale_(const RasterImage_gray* patImg, const Blob* patBlob,
                                              float* patCorrScale)
{
    setPattern(patImg, patBlob);
...
bool PatternMatcher2D_medianDiff::isProperMatchRecordType_(const Pattern2DMatchRecord* matchRecord) const
{
    //  the correlation matcher only requires a generic match record
    return true;
}

Pattern2DMatchRecord* PatternMatcher2D_medianDiff::newPattern2DMatchRecord_(void)
{
...
void PatternMatcher2D_medianDiff::deleteRasters_(void)
{
...
void PatternMatcher2D_medianDiff::allocateRasters_(const RasterImage* patImg, const Blob* patBlob)
{
