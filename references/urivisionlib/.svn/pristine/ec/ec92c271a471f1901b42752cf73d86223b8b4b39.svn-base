/*  NAME:
        _ImageTransformation_QT.h

    DESCRIPTION:
        _ImageTransformation_QT private header.
...
*/
#ifndef _URIVL_IMAGE_TRANSFORMATION_QT_H
#define _URIVL_IMAGE_TRANSFORMATION_QT_H
...
// safeguard the loading of this header
	...
	namespace uriVL
	{
		 ...
		 */
		class URIVL_EXPORT _ImageTransformation_QT
		{
			public:
			...
			private:
				 ...
				 */
				_ImageTransformation_QT(void) { }
				
				/**	 Disabled copy constructor
				 *	@param	obj		the object <b>not</b> to copy
				 */
				_ImageTransformation_QT(const _ImageTransformation_QT& obj) { }
				 ...
				 *	@return	should not
				 */
				const _ImageTransformation_QT& operator = (const _ImageTransformation_QT& obj) { return *this; }
...
#endif	//	_URIVL_IMAGE_TRANSFORMATION_QT_H
