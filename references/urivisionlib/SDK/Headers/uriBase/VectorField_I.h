...
*/
#ifndef URIVL_VECTOR_FIELD_I_H
#define URIVL_VECTOR_FIELD_I_H
...
namespace uriVL
{
    /** VectorField_I class
     *
     *  A VectorField_I is an "integer" vector field defined over a 2d array.
     ...
     *                              University of Rhode Island
     */
    class URIVL_EXPORT VectorField_I : public VectorField
    {
        public:
            /**
             *  Initializes a int vector field at the specified dimensions and values.
             *
             *  @param      nbRows     number of rows of the vector field
             *  @param      nbCols     number of columns of vector field
             */
            VectorField_I(int theNbRows, int theNbCols);

            /**
             *  Initializes an int vector field at the specified dimensions.
             *
             *  @param      theRect     rectangle at which to allocate the vector field
             */
            VectorField_I(const ImageRect* theRect);

            /**
             *  Cloner Constructor.
             *
             *  Initializes a int vector field at the dimensions and values of the
             *  VectorField received as parameter.
             *
             *  @param      theField   pointer to the VectorField object to clone
             */
            VectorField_I(VectorField* theField);
             ...
             */
            VectorField_I(int theNbRows, int theNbCols, const int* theRastX, const int* theRastY);

            /**
             *  Destructor.
             */
            virtual ~VectorField_I(void);
             ...
             */
            void getMinMax(int* theMinX, int* theMaxX,
                           int* theMinY, int* theMaxY) const;

            /** Calculates the min and max values of the vector field along its X direction.
             *  @param  theMinX pointer to min value along X direction
             *  @param  theMaxX pointer to max value along X direction
             */
            void getMinMaxX(int* theMinX, int* theMaxX) const;

            /** Calculates the min and max values of the vector field along its Y direction.
             *  @param  theMinY pointer to min value along Y direction
             *  @param  theMaxY pointer to max value along Y direction
             */
            void getMinMaxY(int* theMinY, int* theMaxY) const;
        ...
        private:
             ...
             */
            VectorField_I(const VectorField_I& theField);
             ...
             *  @param      theField   reference to the VectorField object to copy
             */
            const VectorField_I& operator = (const VectorField_I& theField);
             ...
             */
            void initializeRasters_(const int* rasterX, const int* rasterY);
