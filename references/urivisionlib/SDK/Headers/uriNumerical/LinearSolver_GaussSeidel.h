/*  NAME:
    LinearSolver_GaussSeidel.h
 
  DESCRIPTION:
    LinearSolver_GaussSeidel public header.
...
*/
#ifndef URIVL_LINEAR_SOLVER_GAUSS_SEIDEL_H
#define URIVL_LINEAR_SOLVER_GAUSS_SEIDEL_H
...
namespace uriVL
{
    /** Class that implement the Gauss-Seidel iterative algorithm for solving SLEs.
	 *
     ...
     *                      University of Rhode Island
     */
    class URIVL_EXPORT LinearSolver_GaussSeidel : public LinearSolver
    {
        public:

            /** Space is allocated for a new LinearSolver_GaussSeidel object. That matrix must have
             ...
             */
            LinearSolver_GaussSeidel(int nbRows, int nbCols);


            /** Constructor.  A LinearSolver_GaussSeidel is created for a specific matrix.
             ...
             */
            LinearSolver_GaussSeidel(Matrix* A, bool preserveMatrix=false);
...
//             *                          advance.
//             */
//            LinearSolver_GaussSeidel(int n, int nbRighSideCols=1);
            
            
            /** Destructor
             */
            ~LinearSolver_GaussSeidel(void);
        ...
        private:
             ...
             */
            LinearSolver_GaussSeidel(const LinearSolver_GaussSeidel& obj);

            /** Copy operator: disabled.
			 *	@param	obj		reference to the object to copy
             */
            const LinearSolver_GaussSeidel& operator = (const LinearSolver_GaussSeidel& obj);
...
#endif  //  LINEAR_SOLVER_GAUSS_SEIDEL_H
