/*  NAME:
        ColorGaussianFilter_F.h
 
    DESCRIPTION:
        ColorGaussianFilter_F public header.
...
*/
#ifndef URIVL_COLOR_GAUSSIAN_FILTER_F_H
#define URIVL_COLOR_GAUSSIAN_FILTER_F_H
...
namespace uriVL
{
     ...
     */
    class URIVL_EXPORT ColorGaussianFilter_F : public ColorGaussianFilter
    {
        public:
             ...
             */
            ColorGaussianFilter_F(double theScale);
             ...
             */
            ColorGaussianFilter_F(int theWidth);
             ...
             */
            ColorGaussianFilter_F(double theScale, const ImageRect*  theRect);
             ...
             *  @param theRect  bounding rectangle for the temporary raster
             */
            ColorGaussianFilter_F(int theWidth, const ImageRect*  theRect);

            /** Destructor
             */
            ~ColorGaussianFilter_F(void);
        ...
        private:
             ...
             */
            ColorGaussianFilter_F(const ColorGaussianFilter_F& obj);
             ...
             *  @param  obj   reference of the object to copy
             */
            const ColorGaussianFilter_F& operator =(const ColorGaussianFilter_F& obj);
...
#endif  //  COLOR_GAUSSIAN_FILTER_F_H
