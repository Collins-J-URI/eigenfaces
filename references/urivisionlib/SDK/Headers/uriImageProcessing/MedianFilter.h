...
*/
#ifndef URIVL_MEDIAN_FILTER_H
#define URIVL_MEDIAN_FILTER_H
...
namespace uriVL
{
     ...
     *                              University of Rhode Island
     */
    class URIVL_EXPORT MedianFilter : public ImageOperator
    {
        public:
        ...
        protected:
			 ...
			 *	@param	isIntOperator	true if this operator produces only integer output
             */
            MedianFilter(int theWidth, int theHeight, bool isIntOperator = false, 
			 ...
			 *	@param	isIntOperator	true if this operator produces only integer output
             */
            MedianFilter(const ImageRect* theRect, bool isIntOperator = false, 
						 ConversionFromFloatMode mode = kSignedFloat);
