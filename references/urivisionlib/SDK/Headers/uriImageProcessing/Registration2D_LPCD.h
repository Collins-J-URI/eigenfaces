/*  NAME:
        Registration2D_LPCD.h

    DESCRIPTION:
        Registration2D_LPCD public header.
...
*/
#ifndef URIVL_REGISTRATION_2D_LPCD_H
#define URIVL_REGISTRATION_2D_LPCD_H
...
namespace uriVL
{
    /** Class for objects that register two sets of image points using the Local Consistency
     *  of Point Data (LCPD) algorithm of Urano, Kaneko, and Tanak (2006).  
     *
     *  @author jean-yves herve', 3D Group for Interactive Visualization, 
     *                              Department of Computer Science and Statistics,
     *                              University of Rhode Island
     */
    class URIVL_EXPORT  Registration2D_LPCD : public Registration2D
    {
        public:
        
            /** Constructor
             */
            Registration2D_LPCD(void);
