...
const int MIN_BLOB_SIZE = 60;
const int MAX_BLOB_SIZE = 250;
...
const int	UPPER_LEFT = 0,
            ...
            LOWER_LEFT = 2,
            LOWER_RIGHT = 3;
const float RENDER_SCALE = 0.75f;
...
RasterImage_HSV*		gInputImage = NULL;
...
void initThresholds(void)
{
    ...
    gColorParams->colorReg[0].valMin = 60;
    ...
    gColorParams->colorReg[2].labelStr = "yellowish";
    gColorParams->colorReg[2].hueRef = 60;
    gColorParams->colorReg[2].deltaHue = 25;
    gColorParams->colorReg[2].satMin = 60;
    gColorParams->colorReg[2].satMax = 100;
    gColorParams->colorReg[2].valMin = 30;
    gColorParams->colorReg[2].valMax = 255;
    gColorParams->colorReg[2].fillColor[0] = static_cast<unsigned char>(255);
    gColorParams->colorReg[2].fillColor[1] = static_cast<unsigned char>(255);
    gColorParams->colorReg[2].fillColor[2] = static_cast<unsigned char>(0);
    gColorParams->colorReg[2].label = static_cast<char>(3);

    gColorParams->colorReg[3].labelStr = "redish";
    gColorParams->colorReg[3].hueRef = 0;
    gColorParams->colorReg[3].deltaHue = 25;
    gColorParams->colorReg[3].satMin = 60;
    gColorParams->colorReg[3].satMax = 100;
    gColorParams->colorReg[3].valMin = 30;
    gColorParams->colorReg[3].valMax = 255;
    gColorParams->colorReg[3].fillColor[0] = static_cast<unsigned char>(255);
    gColorParams->colorReg[3].fillColor[1] = static_cast<unsigned char>(0);
    gColorParams->colorReg[3].fillColor[2] = static_cast<unsigned char>(0);
    gColorParams->colorReg[3].label = static_cast<char>(4);
...
void myDisplay3(void)
{
	...
	char infoStr[256];
	sprintf(infoStr, "Blob min size: %d ", static_cast<int>(gBlobMinSize));
...
//	gInputImage = new RasterImage_RGBa(&imgRect);
	gInputImage = new RasterImage_HSV(&imgRect);
